...
CREATE USER [123456789] FOR LOGIN [123456789]
EXEC sp_addrolemember 'NHASIROLE', [123456789];

EXEC sp_addlogin '987654323', '12345', 'DOANHQT'; 
CREATE USER [987654323] FOR LOGIN [987654323]
EXEC sp_addrolemember 'NHANVIENROLE', [987654323];
--Bac si
...
--KhachHang
EXEC sp_addlogin '555555551', '12345', 'DOANHQT';  
GO
CREATE USER [555555551] FOR LOGIN [555555551]
GO
CREATE ROLE KHACHHANGROLE;
EXEC sp_addrolemember 'KHACHHANGROLE', [555555551];
...
GRANT SELECT ON LichCaNhanNS TO KHACHHANGROLE
GRANT SELECT ON DichVu TO KHACHHANGROLE
GRANT SELECT ON HoaDon TO KHACHHANGROLE
...
GRANT EXECUTE ON OBJECT::Sp_UpdateDichVu_2_FIX TO QUANTRIROLE
--NhanVien
